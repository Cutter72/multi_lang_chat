  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        //         context, AuthGateScreen.routeName, (route) => false);
        //   },
        // ),
        // ElevatedButton(
        ...
        //     var textToTranslate =
        //         "To jest tkast który powinien zostać przetłumaczony.";
        //     _logger.e("Original: $textToTranslate");
        //     translator
        //         .autoTranslateTo(textToTranslate, "en")
        //         .then((value) => _logger.e("Translated: $value"));
        //   },
        // ),
        // ElevatedButton(
        ...
        //     Db.chatRooms
        //         .doc(lauUid)
        //         .set(ChatRoom(uid: "uid", roleFor: {lauUid: "owner"}))
        //         .then((value) {
        ...
        //   onPressed: () {
        //     Db.chatRooms
        //         .doc("$lauUid/msgs/$lauUid")
        //         .get()
        //         .then((snap) => _logger.d("Read msg work! data = $snap"));
        //   },
        // ),
        // ElevatedButton(
        ...
        //         .doc("$lauUid/msgs/$lauUid")
        //         .delete()
        //         .then((_) => _logger.d("Delete msg work!"));
        //   },
        // ),
        // ElevatedButton(
        ...
        //   onPressed: () {
        //     Db.contacts
        //         .where(FieldPath.fromString("accepted.$lauUid"),
        //             isNotEqualTo: null)
        //         .where(FieldPath.fromString("rejected.$lauUid"),
        //             isNotEqualTo: null)
        //         .where(FieldPath.fromString("pending.$lauUid"),
        //             isNotEqualTo: null)
        //         .get()
        //         .then((value) {
